...
@section('content')
    <main>
        <div class="container py-4 w-50">
            <h1 class="text-center my-2">Comic Editing</h1>
            @if ($errors->any())
            ...
            <form class="d-inline" action={{ route('comic.update', $comic) }} method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('price') is-invalid @enderror" name="sale_date"
                        id="sale_date" placeholder="Comic Sale Date" value="{{ old('sale_date', $comic->sale_date) }}">
                    @error('sale_date')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control  @error('series') is-invalid @enderror" name="series"
                        id="series" placeholder="Comic Series" value="{{ old('series', $comic->series) }}">
                    @error('series')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('type') is-invalid @enderror" name="type"
                        id="type" placeholder="Comic Type" value="{{ old('type', $comic->type) }}">
                    @error('type')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" id="description" placeholder="Comic Description"rows="3">{{ old('description', $comic->description) }}</textarea>
                </div>
